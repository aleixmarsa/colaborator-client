...
function ProjectCards (props) {
    ...
    const updateCardStat = (cardId, destination) => {
        ...
        axios
            .put(`${API_URL}/colaborator-API/projects/card/updateCard/${cardId}/${destination}`)
            .then((response) => {   
    ...
    const updateCards = (result) => {
        ...
        setCards(prevTasks => reorder(prevTasks));
                                    ...
                                    { (droppableProvided) => (
                                        <div className="p-6 bg-stone-50" >
                                                ...
                                                className="">
                                            {
                                                ...
                                                if(card.stat === "TODO" && card.project === projectId) {
                                                    return (
                                            ...
                                            <button onClick={() => setCardForm(true)} type="button" className="inline-flex items-center p-1 border border-transparent rounded-full shadow-sm text-white bg-green-700 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 m-5">
                            ...
                            { (droppableProvided) => (
                                    <div className="p-6 bg-stone-50" >
                                            ...
                                            className="">
                                        {
                                            ...
                                            if(card.stat === "PROGRESS" && card.project === projectId) {
                                                return (
                                                <Draggable key={card._id} draggableId={card._id} index={index}>
                                                    {(draggableProvided) => (
                                                        <div {...draggableProvided.draggableProps}
