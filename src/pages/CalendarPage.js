            ...
            <div className="lg:flex lg:h-full lg:flex-col">
              <header className="relative z-20 flex items-center justify-between border-b border-gray-200 py-4 px-6 lg:flex-none">
                <h1 className="text-lg font-semibold text-gray-900">
                  <time dateTime="2022-01">{date.getDay().toString()} / {date.getMonth().toString()} / {date.getYear().toString()}</time>
                </h1>
                <div className="flex items-center">
                  ...
                  <div className="hidden md:ml-4 md:flex md:items-center">
                    ...
                    <button
                      type="button"
                      className="focus:outline-none ml-6 rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                    >
                      Add event
                    </button>
                  </div>
              ...
              <div className="shadow ring-1 ring-black ring-opacity-5 lg:flex lg:flex-auto lg:flex-col m-20 mt-1 mb-1">
